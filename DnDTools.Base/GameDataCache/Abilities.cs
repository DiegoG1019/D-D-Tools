...
namespace DiegoG.DnDTools.Base.Cache
{
    ...
    {
        public static IEnumerable<Ability> All { get; } = ReflectionCollectionMethods.GetAllMatchingTypeStaticPropertyValues<Ability>(typeof(Abilities));
        public static Ability SneakAttack => new Ability()
        {
            ...
            Notes = new NoteList()
            {
                "One extra d6 per ability level",
            }
        };
