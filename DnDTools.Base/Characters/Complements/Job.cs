...
namespace DiegoG.DnDTools.Base.Characters.Complements
{
    ...
    public sealed class Job : CharacterTrait<Job>, INoted
    {
        ...
        public ObservableCollection<string> Competence
        {
            get => CompetenceField; set
            {
                CompetenceField = value;
                NotifyPropertyChanged();
            }
        }
        ...
        {
            get => SkillPointsField; set
            {
                SkillPointsField = value;
                NotifyPropertyChanged();
            }
        }
        ...
        public SafeIndexList<int> AllBaseAttackBonuses
        {
            get => AllBaseAttackBonusesField; set
            {
                AllBaseAttackBonusesField = value;
                NotifyPropertyChanged();
            }
        }
        private SafeIndexList<int> AllBaseAttackBonusesField = new SafeIndexList<int>(20);
        public SafeIndexList<SavingThrowBase> AllSavingThrows
        {
            get => AllSavingThrowsField; set
            {
                AllSavingThrowsField = value;
                NotifyPropertyChanged();
            }
        }
        private SafeIndexList<SavingThrowBase> AllSavingThrowsField = new SafeIndexList<SavingThrowBase>(20);
        public SafeIndexList<SafeIndexList<Ability>> AllAbilities
        {
            get => AllAbilitiesField; set
            {
                AllAbilitiesField = value;
                NotifyPropertyChanged();
            }
        }
        private SafeIndexList<SafeIndexList<Ability>> AllAbilitiesField = new SafeIndexList<SafeIndexList<Ability>>(20);
        public SafeIndexList<SafeIndexList<int>> AllDailySpells
        {
            get => AllDailySpellsField; set
            {
                AllDailySpellsField = value;
                NotifyPropertyChanged();
            }
        }
