...
namespace DiegoG.DnDNetCore.Characters
{
    ...
    public sealed class Description : CharacterTrait<Description>, INoted
    {
        ...
        public Color EyeColor { get; set; } = Colors.SandyBrown;
        public Color HairColor { get; set; } = Colors.Black;
        public Color SkinColor { get; set; } = Colors.BlanchedAlmond;
        public NoteList Notes { get; set; } = new NoteList();

        public Color Bgcolor { get; set; } = Colors.Transparent;
        public Color BannerColor { get; set; } = Colors.Transparent;
